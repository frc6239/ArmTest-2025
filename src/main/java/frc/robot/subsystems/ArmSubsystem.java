...
this.Enabled();
   // m_enabled = true;
    ...
    m_motorConfig.closedLoop.maxMotion
        ...
        .maxVelocity(ArmSystemConstants.kMotorRpm)
        .maxAcceleration(ArmSystemConstants.kMotorRpm)
  ...
  public void deploy() {
    if (m_enabled) {
      setPosition(ArmSystemConstants.kMaxPosition);
    } else {
      // send an alert
    }
  }
  ...
  public void lift() {
    if (m_enabled) {
      setPosition(ArmSystemConstants.kLiftPosition);
    } else {
      // send an alert
    }
  }
  ...
  public void retract() {
    if (m_enabled) {
      setPosition(ArmSystemConstants.kMinPosition);
    } else { 
      // send an alert
    }
  }
